...
module.exports.createToken = function (props) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, post("/tokens/create", props)];
...
module.exports.deleteToken = function (tokenId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, del("/tokens/".concat(tokenId))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
module.exports.readToken = function (tokenId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, get("/tokens/".concat(tokenId, "/read"))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
module.exports.redeemToken = function (tokenId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, patch("/tokens/".concat(tokenId, "/redeem"))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
module.exports.revokeToken = function (tokenId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, patch("/tokens/".concat(tokenId, "/revoke"))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
